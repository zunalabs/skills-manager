...
export function ToolIcon({ tool, size = 24 }: { tool: string; size?: number }) {
  ...
  if (tool === 'Goose') {
    return <img src="./goose.png" width={size} height={size} style={{ objectFit: 'contain' }} alt="Goose" className="goose-icon" />
  }
